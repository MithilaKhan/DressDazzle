...
const HolidayFrame = () => {
    return (
        <div className='mt-20'>
            <h1 className='text-3xl font-semibold uppercase pb-3'>Holiday Hall of Frame</h1>
<div className='bg-[#7E1717]  '>
             
           <div className='grid grid-cols-2 pt-10 py-4'>

            {/* 1st side  */}
            <div className=' p-8 text-white'>
            <h1 className='text-5xl font-bold uppercase py-4'>All The Greatest Gifts</h1>
            <p className='text-xl'>Explore our most legendary gifts-from coveted kicks to comfy apparel and more.</p>

            <div className="flex gap-4 p-5 ps-0  ">
    <button
  type="button"
